...
export const lightPalette = {
   ...
   *
   * ⚠️ Carried into the USER palette for the per-app-duplication rule only (the two
   * palettes stay value-identical, `ubexgo-app-conventions`); no user screen draws it.
   */
