...
export default {
  ...
  menu: {
    ...
    servicesLabel: "Тип услуги",
    serviceTaxi: "Такси",
    serviceJonatma: "Посылка",
    serviceUstalar: "Мастера",
    serviceTexnika: "Спецтехника",
    serviceYuk: "Грузовик",
    ctaJonatma: "Отправить посылку",
    ctaUstalar: "Вызвать мастера",
    ctaTexnika: "Вызвать спецтехнику",
    ctaYuk: "Заказать грузовик",
  ...
  searchOffers: {
    ...
    notRatedYet: "Пока нет оценок",
    ratingCount: "Оценок: {count}",
    sortMatch: "Подходящие",
    sortPrice: "Цена",
    sortSeats: "Свободные места",
    sortSoon: "Ближайшие",
    ...
    listBids: "Предложения от водителей",
    fuelBenzine: 'Бензин',
    fuelMetan: 'Метан',
    fuelPropan: 'Пропан',
  ...
  offerDetails: {
    ...
    // T-084 — what the driver offers (T-079/T-080's fields, shown at last).
    whatDriverOffers: 'Что предлагает водитель',
    amenityAirCon: 'Кондиционер',
    amenityWifi: 'Интернет, WiFi',
    amenityRoofRack: 'Багажник на крыше',
    amenityTrailer: 'Прицеп',
    departsWhenFull: 'Выезжает при заполнении',
    parcelAccepted: 'Принимает посылки',
    roadPickup: 'Забирает со стоянки или с трассы',
    // T-081 — the `004 Tanlov oynasi` mockup.
    chooseSpot: 'Выберите подходящее место',
    bySeat: 'По местам',
    backSalon: 'Задний салон',
  ...
  passengerOffers: {
    ...
    scopeRootProvince: 'Область',
    scopeRootDistrict: 'Район',
    scopeRootPickProvince: 'Выберите область',
    scopeRootPickDistrict: 'Выберите область и район',
