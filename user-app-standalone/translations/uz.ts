...
export default {
  ...
  auth: {
    ...
    accountBlockedDescription:
      "Afsuski, sizning hisobingiz bloklangan. Iltimos, qo'llab-quvvatlash xizmati bilan bog'laning yoki keyinroq qayta urinib ko'ring.",
    accountPendingDelete: "Hisobingiz o'chirilmoqda",
    accountPendingDeleteDescription:
      "Sizning hisobingiz o'chirish jarayonida. Agar bu xato bo'lsa, qo'llab-quvvatlash xizmati bilan bog'laning.",
    accountSuspended: "Hisobingiz to'xtatilgan",
    accountSuspendedDescription:
      "Sizning hisobingiz vaqtincha to'xtatilgan. Iltimos, qo'llab-quvvatlash xizmati bilan bog'laning.",
  ...
  phoneRegistration: {
    ...
    footerText:
      "yuqoridagi platformalar yordamida ro'yxatdan o'tish orqali men ",
    ...
    login: "Kirish",
    errorPhoneIncomplete:
      "Iltimos telefon raqamingizni to'liq kiriting (9 raqam)",
    errorGoogleNotReady:
      "Google xizmati tayyor emas. Iltimos qayta urinib ko'ring.",
    errorGoogleCancelled: "Google orqali kirish bekor qilindi",
    errorNetwork:
      "Internet aloqasi bilan muammo. Iltimos qayta urinib ko'ring.",
  ...
  otpVerification: {
    ...
    errorNoAttemptsMessage:
      "3 marta noto'g'ri kod kiritdingiz. Qaytadan telefon raqamingizni kiriting.",
  ...
  menu: {
    ...
    driverOffersSubtitle:
      "Haydovchilar takliflarini ko'ring va safarga qo'shiling",
  ...
  networkStatus: {
    ...
    noInternetMessage:
      "Serverga ulanib bo'lmadi. Taksi buyurtma qilishni davom ettirish uchun internet aloqangizni tekshiring.",
  ...
  searchOffers: {
    ...
    listBids: "Haydovchilardan kelgan takliflar",
    fuelBenzine: "Benzin",
    fuelMetan: "Metan",
    fuelPropan: "Propan",
    fuelElectric: "Elektr",
  ...
  offerDetails: {
    ...
    whatDriverOffers: "Haydovchi nima taklif qiladi",
    amenityAirCon: "Konditsioner",
    amenityWifi: "Internet, WiFi",
    amenityRoofRack: "Tom bagajnik",
    amenityTrailer: "Pritsep",
    departsWhenFull: "To'lishi bilan yuradi",
    parcelAccepted: "Jo'natma olinadi",
    roadPickup: "Pitakdan yoki yo'ldan oladi",
    // T-081 — the `004 Tanlov oynasi` mockup.
    chooseSpot: "O'zingizga maqul bo'lgan joyni tanlang",
    bySeat: "O'rin bo'yicha",
    backSalon: "Orqa salon",
    ...
    confirmJoinMessage:
      "{seats} o'rin uchun {price} {currency} so'rov yuborilsinmi?",
    ...
    priceBreakdownPremium:
      "Oldingi o'rin uchun qo'shimcha ({seats} × {premium} {currency})",
    ...
    joinSuccessMessage:
      "Qo'shilish so'rovi yuborildi! Haydovchi sizning so'rovingizni tasdiqlaydi.",
  ...
  myBookings: {
    ...
    noBookingsMessage:
      "Takliflarni qidiring va safarga qo'shiling, bu erda sizning bronlaringizni ko'rasiz",
  ...
  passengerOffers: {
    ...
    scopeRootProvince: "Viloyat",
    scopeRootDistrict: "Tuman",
    scopeRootPickProvince: "Viloyatni tanlang",
    scopeRootPickDistrict: "Viloyat va tumanni tanlang",
    ...
    roadPickupPlaceholder:
      "Qo'yliq vodiy pitakka chiqib turaman. Oybek metro oldiga chiqib turaman.",
    additionalInfo: "Qo'shimcha ma'lumot",
    additionalInfoPlaceholder:
      "2ta sumkam bor, yashik bor, tom bagajnikka muzlatkich yuklab olamiz",
    ...
    errorCreateMessage:
      "Safar so'rovini yaratib bo'lmadi. Iltimos, qayta urinib ko'ring.",
    // My Passenger Offers
    ...
    tokenExpired:
      "Sizning sessiyangiz tugagan yoki noto'g'ri. Iltimos, qayta kirish qiling.",
