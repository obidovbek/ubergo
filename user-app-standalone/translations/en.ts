...
export default {
  ...
  offerDetails: {
    ...
    whatDriverOffers: 'What the driver offers',
    amenityAirCon: 'Air conditioning',
    amenityWifi: 'Internet, WiFi',
    amenityRoofRack: 'Roof rack',
    amenityTrailer: 'Trailer',
    departsWhenFull: 'Leaves once full',
    parcelAccepted: 'Carries parcels',
    roadPickup: 'Picks up from the stand or the road',
    // T-081 — the `004 Tanlov oynasi` mockup.
    chooseSpot: 'Choose the spot that suits you',
    bySeat: 'By seat',
    backSalon: 'Back salon',
