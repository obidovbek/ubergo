 ...
 * in the driver app — keeps working unchanged.
 */
 ...
 * - the other abort branches across `api/` throw **"Request timeout…"** and were matched;
 * - and most of `auth.ts` has **no abort branch at all** — 7 of its 8 exported functions
