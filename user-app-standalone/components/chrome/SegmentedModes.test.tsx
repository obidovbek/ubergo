 ...
 * provider stack mounts (navigator, safe area, language, auth stub, dialog) — not just the
 * component. The radius assertion pins the defect T-101 step 17b found in BOTH apps: the
 * segment read the deprecated 24 alias on a control measured at 12, and nobody saw it because
 * nothing had run on a device.
 */
