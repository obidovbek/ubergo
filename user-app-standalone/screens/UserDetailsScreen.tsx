...
export const UserDetailsScreen: React.FC = () => {
  ...
  // (T-036) — they were duplicated verbatim in EditProfileScreen.
  ...
  const addPhoneNumber = () => {
    ...
    // an additional number must not repeat the main registration number.
...
const styles = StyleSheet.create({
  ...
  logo: {
    ...
    marginBottom: 12,
    letterSpacing: 0.5,
    textShadowColor: theme.palette.successTint,
