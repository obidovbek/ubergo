 ...
 *
 * 2026-09-19: 5 such calls in this app (4 in `NotificationContext`), 4 in the driver app — where
 * the same screen also called `showToast` as a function and so threw instead of toasting.
 *
 * Duplicated in the driver app on purpose, like the shared components.
 */
