...
- [x] 11. **DONE 2026-08-08 — committed by the owner as `34988cc`.**
...
**Committed 2026-08-08:** T-036 as **`34988cc`**, T-033 as **`6b691ab`**. Step 11 is done.
⚠️ `34988cc` also swept in unrelated in-progress work (`PassengerOfferService.ts`,
`CreatePassengerOfferScreen.tsx`, `TimeWindowCard.tsx`, `CHECKLIST.md`, `PLAN-T018.md`) and
`.claude/settings.json`. Nothing was reverted — just know it if this commit ever needs unpicking.
