...
export default {
  ...
  errors: {
    ...
    network: 'Проблема с подключением к интернету. Пожалуйста, проверьте ваше интернет-соединение.',
    timeout: 'Время запроса истекло. Пожалуйста, попробуйте снова.',
    badRequest: 'Неверный запрос',
    unauthorized: 'Требуется аутентификация. Пожалуйста, войдите снова.',
    forbidden: 'У вас нет разрешения на выполнение этого действия',
    notFound: 'Данные не найдены',
    conflict: 'Эти данные уже существуют',
    validation: 'Пожалуйста, введите данные правильно',
