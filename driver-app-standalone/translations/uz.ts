...
export default {
  ...
  offerWizard: {
    ...
    amenityAirCon: 'Konditsioner',
    amenityWifi: 'Internet, WiFi',
    amenityRoofRack: 'Tom bagajnik bor',
    amenityTrailer: 'Pritsep bor',
    parcelAccepted: 'Jo\'natma (pochta) olinadi',
    parcelPriceLabel: 'Jo\'natma narxi (so\'m)',
    parcelMaxKgLabel: 'Eng ko\'pi (kg)',
    parcelMaxKgHelper: 'Masalan 20 — 20 kg gacha jo\'natma olaman.',
    roadPickupLabel: 'Faqat pitakdan yoki yo\'lga chiqib tursa olaman',
    roadPickupPlaceholder: 'Masalan: Qo\'yliq vodiy pitakdan yoki Farg\'onaga ketish yo\'liga chiqib tursa olaman',
    ...
    priceWholeSalonHelper: 'Butun mashinani bir kishi band qilsa',
    waitingFeeLabel: 'Kutish narxi (so\'m/minut, ixtiyoriy)',
    waitingFeeHelper: 'Yo\'lovchiga ko\'rsatiladi. Dastur bu pulni hisoblamaydi va yechmaydi.',
    freeWaitingLabel: 'Bepul kutish (minut)',
    freeWaitingHelper: 'Shu vaqtdan keyin kutish narxi boshlanadi. 0 ham bo\'lishi mumkin.',
    pickupFeeLabel: 'Joyidan olish narxi (so\'m)',
    pickupFeeHelper: '0 desangiz — joyidan olish bepul.',
    paymentLabel: 'To\'lov turi',
    paymentCash: 'Naqd',
    paymentCard: 'Click, Payme',
    vehicleClassLabel: 'Avto sinfi',
    vehicleClass_standard: 'Standart',
    vehicleClass_comfort: 'Comfort',
    vehicleClass_business: 'Biznes',
    vehicleClass_econom: 'Econom',
    vehicleClass_tourist: 'Turistik',
  ...
  // T-101 step 18 — the driver's rides screen (`DriverMyOrder`). Keys returned by
  // `utils/myRides.ts`; swept by `scripts/check-offer-i18n.mjs`.
  myRides: {
    phaseJarayon: 'Jarayonda',
    phaseFaol: 'Faol buyurtmalar',
    phaseTarix: 'Buyurtmalar tarixi',
    emptyJarayon: 'Jarayondagi reys yo\'q',
    emptyFaol: 'Faol reys yo\'q',
    emptyTarix: 'Buyurtmalar tarixi bo\'sh',
    stateCollecting: 'Yig\'ilmoqda',
    stateConfirmed: 'Tasdiqlangan',
    stateDone: 'Yakunlangan',
    fillFull: 'Buyurtma to\'ldi',
    fillOpen: 'O\'rindiqlar to\'lmagan',
    incomeExpected: 'kutilayotgan daromad',
    incomeEarned: 'olingan daromad',
    statSeats: "band o'rindiq",
    statOrders: 'Buyurtma',
    pastHint: "Jo'nash vaqti o'tgan — reysni yakunlab arxivga o'tkazing.",
    cancelRide: 'Reysni bekor qilish',
    bookedAt: 'Buyurtma vaqti',
    bookingTitle: 'Buyurtma tafsiloti',
    passengersHeading: "Shu reysdagi yo'lovchilar",
    ordersCount: "{count} ta buyurtma",
    reasonCarBroken: 'Mashinam buzilib qoldi.',
    reasonCarNotRunning: 'Mashinam yurmayapdi.',
    reasonNoFuel: 'Yoqilg\'i quya olmadim.',
    reasonPassengerLied: 'Yo\'lovchi aldadi. Yolg\'onchi ekan.',
    reasonNoAnswer: 'Yo\'lovchi telefonni ko\'tarmadi.',
    reasonNotLeftHome: 'Yo\'lovchi uyidan chiqmadi.',
    reasonNotAtAddress: 'Yo\'lovchi aytilgan manzildan chiqmadi.',
    reasonWrongAddress: 'Yo\'lovchi noto\'g\'ri manzil tanlagan ekan.',
    reasonOther: 'Boshqa',
  },
  passengerOrders: {
    priceListed: "E'lon narxi",
    pricePassenger: "Yo'lovchi narxi",
    priceMine: "Taklif narxingiz",
    kindOddiy: "Oddiy",
    kindMaxsus: "Maxsus (pullik)",
    people: "kishi",
    // 17d: the screen
    title: "Shaharlar aro",
    kindTaxi: "Taxi",
    kindParcel: "Jo'natma",
    modeIncoming: "Kelgan buyurtmalar",
    modeSent: "Taklif yuborish",
    tabAll: "Hammasi",
    tabOddiy: "Oddiy",
    tabMaxsus: "Maxsus buyurtma",
    sortMatch: "Eng mos",
    sortPrice: "Narx",
    sortSeats: "Yo'lovchi",
    sortSoon: "Eng tez",
    titleIncoming: "Yo'lovchilardan kelgan buyurtmalar",
    titleOddiy: "Oddiy buyurtmalar — e'lon narxi bo'yicha",
    titleMaxsus: "Maxsus (pullik) — yo'lovchi narxi bo'yicha",
    titleSent: "Yuborilgan takliflar",
    countOrders: "ta buyurtma",
    countOffers: "ta taklif",
    emptyIncoming: "Kelgan buyurtma yo'q",
    emptySent: "Yuborilgan taklif yo'q",
    anyRoute: "Barcha yo'nalishlar",
    // 17e: the sheet
    sheetIncoming: "Yo'lovchi buyurtmasi",
    sheetSent: "Sizning taklifingiz",
    code: "Buyurtma",
    seatsTitle: "So'ralgan o'rindiqlar",
    seatKind: "Joy turi",
    specialTitle: "Maxsus buyurtma narxlari",
    payment: "To'lov",
    phone: "Telefon",
    phoneHidden: "Yo'lovchi tasdiqlagach ochiladi",
    accept: "Qabul qilish",
    offer: "Taklif yuborish",
    yourPrice: "O'z narxingiz",
    thousands: "000",
    sendOffer: "Taklifni yuborish",
    notePlaceholder: "Izoh: yo'l ustida olaman, katta yukxona bor...",
    acceptConfirmTitle: "Buyurtmani qabul qilasizmi?",
    acceptConfirmBody: "Yo'lovchiga e'lon narxida taklif yuboriladi. Telefon raqami yo'lovchi tasdiqlagach ochiladi. Jami:",
    // 17f: the result dialog
    resultAcceptTitle: "Buyurtma qabul qilindi",
    resultAcceptBody: "Yo'lovchiga e'lon narxida taklif yuborildi. U tasdiqlagach telefon raqami ochiladi va bildirishnoma olasiz.",
    resultOfferBody: "Yo'lovchi taklifni ko'rib chiqadi. Javob kelganda bildirishnoma olasiz.",
    resultOfferPrice: "Taklif narxi",
    resultTotal: "Jami to'lov",
    close: "Yopish",
  },
};
