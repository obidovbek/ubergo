 ...
 *
 * ðŸ”´ Before this there were TWO families across the two apps â€” 24 call sites, 14
 * of them a bare `<Text>â†</Text>` and 10 an `Ionicons arrow-back` â€” and they did
 ...
 *   - the tap targets ranged from `padding: 8` to a 40Ã—40 box.
 *
 * The shape here is the owner's chosen reference: the passenger app's
 * "search ride" screen (`SearchOffersScreen`) â€” a 40Ã—40 white rounded tile with
 * a soft shadow and a dark `arrow-back` glyph.
 *
 * âš ï¸ Byte-identical to the user app's copy, deliberately â€” the same convention
...
interface BackButtonProps {
  onPress: () => void;
  /** Extra layout (margins, alignment) â€” never re-style the tile itself. */
  ...
  color?: string;
  /**
   * Blocks going back â€” used by the registration screens while a save is in
...
export const BackButton: React.FC<BackButtonProps> = ({
  ...
  <TouchableOpacity
    ...
    // A 40Ã—40 tile is already at the 44pt guideline; this widens the tap area
