...
export const lightPalette = {
  ...
  /**
   * 🔵 THE DRIVER APP'S ONE COLOUR DIFFERENCE — and the only intended delta between
   * this palette and the user app's copy.
   *
   * The header is TWO words: "UbexGo" in `brand` green, then "Driver" in this blue.
   * Measured in all 18 driver artboards; zero user artboards have a second word.
   *
   * ⚠️ This is NOT a driver accent colour. `htmlDesign/docs/00-UMUMIY-loyiha.md` claims
   * blue is "the Driver colour"; measured, green beats blue 398 to 51 in these very
   * artboards. Buttons, active tabs and selected chips here are GREEN, exactly as in
   * the user app. Using this for anything but the wordmark suffix is a bug.
   */
  brandSuffix: '#0049FF',
