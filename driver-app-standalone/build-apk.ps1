# Build APK Script for UbexGo Driver App
# This script builds both debug and release APKs

Write-Host "======================================" -ForegroundColor Green
Write-Host "   UbexGo Driver App APK Build Script" -ForegroundColor Green
Write-Host "======================================" -ForegroundColor Green
Write-Host ""
...
Write-Host "======================================" -ForegroundColor Green
Write-Host ""
Write-Host "Install APK with:" -ForegroundColor Yellow
Write-Host "  adb install -r android\app\build\outputs\apk\<debug|release>\app-<debug|release>.apk" -ForegroundColor Gray
